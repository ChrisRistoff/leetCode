...
function isSameAfterReversals(num: number): boolean {
  ...
  if (numStr[numStr.length-1] !== "0") return true
...
console.log(isSameAfterReversals(18)) // true
console.log(isSameAfterReversals(1800)) // false
console.log(isSameAfterReversals(181)) // true
console.log(isSameAfterReversals(1880)) // false
